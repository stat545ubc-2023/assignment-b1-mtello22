...
The first two examples have instances where the calculation of scores should not be performed, returning a message.

The third example is expected to run because the function would convert the string "0.3" to a numeric version. So it should generate a data frame with the appropriate dimensions and classes for each column.
